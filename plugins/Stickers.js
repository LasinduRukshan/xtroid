...
if (Config.WORKTYPE == 'private') {
    XcriptX.addCommand({pattern: 'sticker$', fromMe: true, }, (async (message, match) => {    
    ...
    XcriptX.addCommand({pattern: 'sticker$', fromMe: false,}, (async (message, match) => {    
    ...
    XcriptX.addCommand({pattern: 'sticker$', fromMe: true, dontAddCMDList: true}, (async (message, match) => {    
